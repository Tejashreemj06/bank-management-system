...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to STATE BANK OF INDIA")
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#b5e8e8",
...
class Error:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Error")
        window.configure(background="#b5e8e8")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#0066FF")
